...
public class homeFuelTestBetween600to800 {

	@Test
	public void homeFuelTestBetween600to800() throws SQLException, ParseException  
	{
	...
	//---------------- Test number 2-----------------///
		...
		float price = (float)  ((700*5.23)*0.97);
		DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd");
		invoice1.setPrice((float) (homefuelorder1.getQuantity()*rates.getMaxHomeFuel()*0.97));
